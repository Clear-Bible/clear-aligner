...
ClearAligner is a cross-platform tool for working with alignment data.
...
To learn about how ClearAligner works, watch the overview video for the [latest build](releases/1.0.0.md). After that, [get started](getting-started.md).
