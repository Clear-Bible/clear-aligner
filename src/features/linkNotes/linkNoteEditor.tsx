...
const LinkNoteDisplayButtonView = ({
  children,
}: LinkNoteDisplayButtonViewProps) => {
  return (
    <Box
      sx={{
        display: 'flex',
  ...
  const lastModifiedBy = useMemo<JSX.Element>(() => {
    ...
    return (
      ...
      >
        ...
        <Typography sx={typographyStyle} component={'span'} display={'inline'}>
          {note?.authorEmail}
        </Typography>
      </Box>
    );
