 ...
 */
export const setMockAmplifySetupState = (stateOverride?: MockAmplifySetupState) => {
  state = {
 ...
 * @param forceRefresh
 */
export const getUserGroups = async (forceRefresh?: boolean): Promise<string[]|undefined> => {
