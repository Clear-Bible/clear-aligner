...
contextBridge.exposeInMainWorld('databaseApi', {
  ...
  getDataSourceLemmaCount: (sourceName: string, side?: string) => ipcRenderer.invoke(`${ChannelPrefix}:getDataSourceLemmaCount`, sourceName, side),
  ...
  corporaGetSourceWords: (sourceName, side, filter, sort) => ipcRenderer.invoke(`${ChannelPrefix}:corporaGetSourceWords`, sourceName, side, filter, sort),
  ...
  corporaGetAlignedWordsBySourceWord: (sourceName, side, normalizedText, sort) => ipcRenderer.invoke(`${ChannelPrefix}:corporaGetAlignedWordsBySourceWord`, sourceName, side, normalizedText, sort),
  corporaGetLemmas: (sourceName, filter, sort) => ipcRenderer.invoke(`${ChannelPrefix}:corporaGetLemmas`, sourceName, filter, sort),
  corporaGetAlignedWordsByLemma: (sourceName, lemma, sort) => ipcRenderer.invoke(`${ChannelPrefix}:corporaGetAlignedWordsByLemma`, sourceName, lemma, sort),
  ...
  findLinkStatusesByAlignedWord: (sourceName: string,
                                  sourcesText?: string,
                                  targetsText?: string,
                                  excludeRejected?: boolean) => ipcRenderer.invoke(`${ChannelPrefix}:findLinkStatusesByAlignedWord`, sourceName, sourcesText, targetsText, excludeRejected),
